...
/** Self-service signup. Fully offline — no email round-trip. The API answers
 * with a German status message (first account becomes admin, later accounts
 * wait for admin approval) which the form shows on success. */
  ...
  const submit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        setDone(data?.message ?? 'Konto erstellt.');
      } catch {
